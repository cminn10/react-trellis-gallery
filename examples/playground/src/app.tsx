...
import { buildPredicate, usePlaygroundState } from './use-playground-state'
...
export default function App() {
	...
	const goToItem = useCallback(
		(
			...
			const predicate = buildPredicate(field, operator, value)
			if (!predicate) {
				setSearchResult(null)
				return
			}
			const result = galleryRef.current?.goToItem(predicate, { highlightDuration: duration })
	...
	return (
		<div className="app-root">
			<nav className="top-links">
				<a href="https://github.com/cminn10/react-trellis-gallery" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="top-link">
				...
				<a href="https://www.npmjs.com/package/react-trellis-gallery" target="_blank" rel="noopener noreferrer" aria-label="npm" className="top-link">
